...
- `references/memory/`: 10 deep-dive knowledge documents (style baseline, CLI local generation, pipeline evolution history, narrative calibration, render-flicker compatibility, subject definitions, delivery records, meta-memory, progress loop).
